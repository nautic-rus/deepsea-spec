...
trait EleEqHelper {
  ...
  def eqByOID(project: String, eqOid: String) = {
      ...
      case Some(connection) => {
        try {
          ...
          if (rs.next()) {
            ...
            val label=calculateDrawingLabel(eq.EQELEC)
            calculateSupports(eq.EQELEC)
            val marigin = calcH(eq)
            val k = 0
  ...
  private def calculateSupports(in: String): Unit = {
    "62\n" +
      "62.1|0185W0103201A2K|796|4\n" +
      "62.2|0188W0004009A2K|796|4\n" +
      "62.3|0199W1300050A2K|796|4\n" +
      "62.4|NR12F37B7D2BBE37|796|4"
