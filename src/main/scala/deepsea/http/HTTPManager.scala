...
//      },
      ...
      (get & path("createEleEsp") & parameter("project", "docNumber", "rev", "user", "kind", "taskId")) { (project, docNumber, rev, user, kind, taskId) =>
        askFor(ActorManager.esp, CreateEsp(project, docNumber, rev, user, kind, taskId))
      },
      ...
      (get & path("eleEspCurrent") & parameter("foranProject", "docNumber", "rev", "user", "taskId")) { (foranProject, docNumber, rev, user, taskId) =>
        askFor(ActorManager.elec, GetEleCurrent(foranProject, docNumber, rev, user, taskId))
      },
      ...
      (get & path("elePos") & parameter("project", "index", "kind")) { (project, index, kind) =>
        askFor(ActorManager.esp, GetElePos(project, index, kind))
      },
