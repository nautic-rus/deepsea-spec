...
//
  ...
  case class AddIssueMaterial(pos: String, units: String, weight: String, count: String, stock: String, userId: String, docNumber: String, issueId: String, addText: String, department: String)
  case class DeleteIssueMaterial(pos: String, docNumber: String,department: String)

  case class IssueMaterial(id: Int, pos: String, units: String, weight: Double, count: Double, stock: String, userId: Int, dateIns: Long, docNumber: String, issueId: Int, addText: String, dep: String){
...
//      sender() ! "success"
    ...
    case AddIssueMaterial(pos, units, weight, count, stock, userId, docNumber, issueId, addText, department) =>
      addMaterial(pos, units, weight.toDoubleOption.getOrElse(0), count.toDoubleOption.getOrElse(0), stock, userId.toIntOption.getOrElse(0), docNumber, issueId.toIntOption.getOrElse(0), addText, department)
