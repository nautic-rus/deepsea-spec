...
object PipeManager{
  ...
  case class PipeSegExtended(project: String, zone: String, system: String, line: String,
                     pls: Int, elem: Int, typeCode: String, typeDesc: String, classAlpha: String, compType: String, compUserId: String, smat: String,
                     sqInSystem: Int, isPieceId: Int, var spPieceId: Int, isom: String, spool: String, var length: Double, radius: Double, angle: Double,
                     weight: Double, stock: String, fcon3: String, insul: String, classDescription: String,
  ...
  case class GetPipeSegsBySystem(system: String)
...
class PipeManager extends Actor with Codecs with PipeHelper {
  ...
  override def preStart(): Unit ={
    //self ! GetPipeSegs("N002", "804-001")
    //self ! GetPipeESP("200101-804-001", "1", "", "ru")
    //self ! GetPipeSegsByDocNumber("200101-574-019")
  ...
  override def receive: Receive = {
    ...
    case GetPipeSegs(project, system, sqInSystem) =>
      ...
      //genSpoolsListEnPDFAll("200101-804-001", "FUEL SYSTEM", "0", jk,"en")
    ...
    case GetPipeSegsByDocNumber(docNumber, json) =>
      ...
      val a = 0
    case GetPipeSegsBySystem(system) =>
      sender() ! getPipeSegsBySystem("N002", system).asJson.noSpaces
