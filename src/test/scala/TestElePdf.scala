...
/*  List[String]("170701-884-3005",
    ...
    "170701-884-5005",
    "170701-884-5006",
    "170701-884-8001").foreach(dr=>{
    val paths3: List[String] = generatePdfToFileNoRev("P701", dr, "C:/23")

  })*/

  val paths3: List[String] = generatePdfToFileNoRev("P701", "170701-884-9003", "C:/23")
